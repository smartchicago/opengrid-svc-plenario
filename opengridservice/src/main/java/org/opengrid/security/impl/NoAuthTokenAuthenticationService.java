...
public class NoAuthTokenAuthenticationService implements TokenAuthenticationService {
	private static final Logger log = Logger.getLogger(NoAuthTokenAuthenticationService.class);
    private static final String AUTH_HEADER_NAME = "X-AUTH-TOKEN";
 
    private final TokenHandler tokenHandler;
    
    private RoleAccessValidator roleAccessValidator = new NoAuthRoleAccessValidator();
    
    public NoAuthTokenAuthenticationService() {
