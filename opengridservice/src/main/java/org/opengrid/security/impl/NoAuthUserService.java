...
public class NoAuthUserService implements org.springframework.security.core.userdetails.UserDetailsService {
	private static final Logger log = Logger.getLogger(NoAuthUserService.class);
    ...
    private User getUser(String username) {
        User u = new User();
        u.setId((long)2323);
        u.setUsername("NoAuth");
        u.setFirstName("Anonymous");
        u.setLastName("");

        //on the LDAP impl, we won't have this
        u.setPassword("NoAuth");//2f132d93-f676-408d-829c-08640835599d");

        //read roles/groups
        //roles 
        u.grantRole(new OpenGridUserRole(org.opengrid.constants.Security.AUTH_PREFIX_RESOURCE + 
